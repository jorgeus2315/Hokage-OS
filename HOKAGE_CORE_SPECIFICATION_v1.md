...
Todas las de esta ronda y las anteriores están resueltas. Lo que queda es **diseño ya especificado pero no implementado**: Secret Management completo, Memory System completo (ahora con `memory.write` ya construido como su primer bloque, ver §6/§2), Hermes v2, paneles por sala. La migración marcadores→Tools, único ítem que sí se implementó en código en esta ronda, ya no aparece aquí — ver arriba.
