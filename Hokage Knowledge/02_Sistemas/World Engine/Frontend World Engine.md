> ⚠️ **Tabla de fases desactualizada respecto a la realidad** — señalado en [[Frontend - Decisiones v2]] (§13 de la especificación actual): el estado real verificado ya supera lo que este documento marca como "pendiente" (Fase 2 cámara libre, Fase 3 departamentos como datos y Fase 4 agentes con estado visual real están hechas; Fase 5 parcial). Acción de bajo coste, no bloqueante, pendiente: actualizar la tabla de fases de abajo a la realidad. Ver [[Frontend - Decisiones v2]] para las decisiones congeladas más recientes sobre este sistema.
>
> Fuente: `docs/specs/FRONTEND_WORLD_ENGINE.md`, verbatim — documento técnico v1.0 (diseño, complementa la arquitectura backend).
...
Complementa [[ARCHITECTURE (legacy)|la arquitectura backend]]. Este documento cubre
...
| Se crea contenido | `CONTENT_CREATED` | aparece un documento que viaja de Marketing (antes "Estudio", ver [[Frontend - Decisiones v2|§13 v3]]) al hub |
...
exactamente el mismo principio que [[Plugin System - Arquitectura Completa|§8.6]] aplica a
...
> ⚠️ Ver [[Frontend - Decisiones v2]] para el estado real verificado de estas fases (2026-08-04) — varias ya superan lo que aquí se marca como pendiente.
...
- [[Frontend - Decisiones v2]] — decisiones congeladas más recientes, estado real de las fases
- [[VISION]] — ambición de producto que este motor sirve
- [[Núcleo - Arquitectura del Core]] — principio rector compartido (§0)
- [[Prison Architect - Arquitectura de Sistemas Complejos|Prison Architect]] — hallazgo R7 (overlays de datos), pendiente de incorporar
