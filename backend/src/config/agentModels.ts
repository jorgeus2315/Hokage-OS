...
export const AGENT_TOOLS: Record<string, string[]> = {
  ...
  contenido:    ['google.trends', 'web.browser', 'content.create', 'etsy.create_listing', 'etsy.update_listing', 'etsy.create_reply', 'memory.write', 'memory.remember', 'decision.create'],
